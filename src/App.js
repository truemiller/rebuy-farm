...
const vaults = {
    elkWavax: new Vault(platforms.elk, farms.elkWavax, "0xd1b524ee1d1278b4770c5d6c97Cf70D3F73358a6", strategies.elkWavax)
}
        ...
        return <>
            <table className="table bg-white shadow ">
                ...
                {Object.keys(vaults).map((vaultKey) => {
                    ...
                    return <VaultRow vault={vault} farm={farm} vaultKey={vaultKey} key={vaultKey} accounts={accounts}/>
                })}
                </tbody>
            </table>
        </>
