...
class Vault {
    ...
    depositedPromise = async () => {
        // console.log("depositedPromise")
        // console.log("Metamask address", await Metamask.address())
        const address = await Metamask.address()
        const balance = await this.contract?.functions?.balanceOf(`${address[0]}`)
        // console.log("balance", balance)
        return balance
    }

    withdrawAllPromise = async () => await this.contract.functions.withdrawAll()
