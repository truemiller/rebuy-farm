...
export const chains = {
    ...
    matic: new Chain("Polygon", "0x89", "0x2791bca1f2de4661ed88a30c99a7a9449aa84174", "https://rpc.ankr.com/polygon", 0.0585),
}
...
export const lps = {
    ...
    maticElkElk: new LP(chains.matic, "ELK/ELK LP", "0xE1C110E1B1b4A1deD0cAf3E42BfBdbB7b5d7cE1C", tokens.elk, tokens.elk, exchanges.elk, true),
}
...
export const farms = {
    ...
    maticElkElk: new Farm(chains.matic, "ELK SINGLE", "0xB8CBce256a713228F690AC36B6A0953EEd58b957", lps.elkElk, platforms.elk, exchanges.elk),
...
export const strategies = {
    ...
    maticElkElk: new Strategy(chains.matic,"ELKELK", "0x687B9268C0b7247C23a8D9DCB8B2149cD3bD2e09", exchanges.elk),
}
